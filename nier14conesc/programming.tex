...
line~\lstref{cg:layered}---used to report a context with another animal
...
\end{lstlisting}
This allows to completely decouple the context-dependent
...
concerns and hence to ease the testing, maintenance, and evolution of
