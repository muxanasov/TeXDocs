...
\fakepar{Self-adaptive embedded system software} Works in this area
...
\fakepar{Context-oriented programming} The COP
...
\fakepar{System-level adaptiveness in CPSs} Specific cases of run-time
