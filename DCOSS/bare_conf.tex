...
{
 morekeywords={components, is, error, default, context, group, layered, command, implementation, contexts, event, call, void, uses, transitions, triggers, iff, activate},
 morecomment=[s]{/*}{*/},
 sensitive=false,
 escapeinside={*}{*}
...
%\title{Language support for Adaptive\\Wireless Sensor Network Software}
%\title{Wireless Sensor Networks Software in Context-Oriented Perspective}
%\title{Context-Oriented Programming for Adaptive\\Wireless Sensor Network Software}
\title{Adaptivity in Low-Level Software for Wireless Sensor Network in Context-Oriented Perspective}
%Design-Time Support
%Low-Level Software
