\begin{abstract}
  ...
  (COP) down to resource-constrained WSN devices. Context information
  drive adaptation decisions. We provide design concepts to organize
  the different WSN operating modes as a function of context. Based on
  these, programmers use a notion of \emph{layered function} to
  implement context-dependent behavioral variations of WSN code. Our
  language implementation, called \conesc, extends nesC with COP
  constructs, and efficiently runs on mainstream WSN devices. Based on
  three representative applications, we show that \conesc
  greatly simplifies the resulting code and yields increasingly
  decoupled implementations compared to nesC, easing debugging and
