...
convenience. It is mandatory, however, to declare \emph{default} context (line~\lstref{isdefault}),
...
\emph{triggers} section. On a figure~\ref{fig:lc} (line~\lstref{triggers}) all
