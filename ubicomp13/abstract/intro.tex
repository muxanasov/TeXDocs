...
While COP already exists in Java and Python, our goal is to bring COP to the low-level languages for WSNs. It is, however, accompanied by several challenges:
